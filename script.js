document.addEventListener('DOMContentLoaded', () => {
    ...
    const initialRisks = [
        ...
        { id: 30, uraianProses: "Tim IPDS", pernyataanRisiko: "Publikasi DDA tidak terbit tepat waktu", penyebabDampak: "Penyebab: Keterlambatan data dari OPD. Dampak: Publikasi terlambat rilis", kategoriRisiko: "Risiko Operasional", sumberRisiko: "Eksternal", probabilitas: 4, dampak: 4, pengendalian: "Koordinasi dan follow up secara berkala ke OPD", responRisiko: "Mengurangi Risiko", prioritas: 1 },
